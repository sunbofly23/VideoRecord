...
public class LauncherActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initViewPager2() {
        ...
        fragments.add(BlankFragment.newInstance(BlankFragment.FLAG_ADAPTER));
