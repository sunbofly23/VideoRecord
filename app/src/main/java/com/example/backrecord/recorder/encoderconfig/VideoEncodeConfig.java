        ...
        public final VideoEncodeConfig readFromPrefs(Context context, int i) {
            ...
            if (configPreferences.contains(VideoEncodeConfig.KEY_VIDEO_HEIGHT)) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.R) {
                     width = (int) (windowManager.getMaximumWindowMetrics().getBounds().width()/DEFAULT_VIDEO_MULTIPLE);
                     height = (int) (windowManager.getMaximumWindowMetrics().getBounds().height()/DEFAULT_VIDEO_MULTIPLE);
                }else{
                    width = (int)(windowManager.getDefaultDisplay().getWidth()/DEFAULT_VIDEO_MULTIPLE);
                    height = (int)(windowManager.getDefaultDisplay().getHeight()/DEFAULT_VIDEO_MULTIPLE);
                }
